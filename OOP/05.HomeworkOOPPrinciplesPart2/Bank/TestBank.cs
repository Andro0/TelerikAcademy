...
namespace Bank
{
    ...
    class TestBank
    {
        ...
        private static Bank LoadAccounts()
        {
            ...
            bank.AddAccount(new MortgageAccount(new Individual("Pesho Peshev"), 50000.0m, 25));
            bank.AddAccount(new DepositAccount(new Company("Pesho Company"), 7500.0m, 12));
            bank.AddAccount(new LoanAccount(new Company("Gosho Company"), 175000.0m, 22));
            bank.AddAccount(new MortgageAccount(new Individual("Djordjano"), 30500.0m, 50));
            bank.AddAccount(new DepositAccount(new Company("MyCompany"), 12450.0m, 13));
            bank.AddAccount(new LoanAccount(new Individual("Tsvetan Vasilev"), 129.0m, 2));
